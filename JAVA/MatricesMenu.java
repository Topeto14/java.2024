...
public class MatricesMenu {
    ...
    public static int sumaDiagonalPrincipal(int[][] tabla){
        int resultado = 0 ;
        for(int i = 0; i< tabla.length; i++){
        resultado += tabla[i][i];
        }
            ...
            do {
                ...
                switch (opcion) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        System.out.println("La suma de la diagonal principal es " + sumaDiagonalPrincipal(tabla)); 
                        break;
                    case 4:
